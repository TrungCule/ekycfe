...
const signin = () => {
  ...
  <div className="container d-flex flex-column flex-root">
    {/*begin::Login*/}
    <div
      className="login login-6 login-signin-on login-signin-on d-flex flex-row-fluid"
      id="kt_login"
    >
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <h1 className="login-title mb-32">
                Cổng thông tin dành cho doanh nghiệp
              </h1>
            </div>
            <div className="col-md-6">
    ...
    >
      <div className="modal-content">
        <div className="modal-header">
          ...
          >
            <img
              src="media/icons-color/subdefault/default/24x24-close.svg"
              alt=""
            />
          </button>
        </div>
        <div className="modal-body">
          <div className="form list-mb24 list-crop">
            <div className="text-left">
              Vui lòng nhập địa chỉ email đã đăng ký. Chúng tôi sẽ gửi lại mật
              khẩu mới cho bạn.
            </div>
            <div className="form-group">
